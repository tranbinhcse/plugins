...
namespace Tino\Plugins\Console\Commands;
...
class GeneratePluginCommand extends PluginCommand
{
     ...
     * @var string
     */
    protected $name = 'tino:make-plugin';
    ...
    protected function getFiles()
    {
        return [
            ...
            'model.stub' => 'src/Models/' . $this->studlyName() . ".php",
            'presenter.stub' => 'src/Presenters/' . $this->studlyName() . "Presenter.php",
            'repository.stub' => 'src/Repositories/' . $this->studlyName() . "Repository.php",
